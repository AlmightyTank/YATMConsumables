...
{
    public override string ModGuid { get; init; } = "com.amightytank.yatmconsumables";
    public override string Name { get; init; } = "YATMConsumables";
    ...
    CLEItemBootstrap cleItemBootstrap) : IOnLoad
{
    public async Task OnLoad()
    {
        try
        {
            ...
            var itemPaths = new[]
            {
                Path.Join("db", "CustomConsumables")
            };
